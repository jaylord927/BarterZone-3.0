...
public class landing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        igive.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        getContentPane().add(signup, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 10, 80, 40));

        login.setBackground(new java.awt.Color(0, 102, 102));
        login.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        login.setForeground(new java.awt.Color(12, 213, 49));
        login.setText("Login");
        ...
        getContentPane().add(login, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 10, 80, 40));

        iwant.setBackground(new java.awt.Color(255, 255, 255));
        iwant.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
    ...
    private void signupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupActionPerformed
        ...
        // Close the current landing frame
